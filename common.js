  ...
  sidebar.innerHTML = `
    ...
    <div class="sidebar-footer">
      <div class="sidebar-user">
        ...
        <div class="user-info">
          <p class="user-email">${user?.user_metadata?.full_name || user?.email || ''}</p>
...
const sidebarCSS = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .sidebar-logo {
    ...
    padding: 1.25rem 1rem; border-bottom: 1px solid #f3f4f6;
  }
  .sidebar-logo-icon {
    width: 36px; height: 36px; background: #2563eb; border-radius: 0.625rem;
  ...
  .user-avatar {
    ...
    display: flex; align-items: center; justify-content: center;
    font-size: 0.8rem; font-weight: 600; color: #374151; flex-shrink: 0;
  }
  ...
  .logout-btn {
    ...
    border-radius: 0.5rem; font-size: 0.8rem; color: #9ca3af;
